...
/**
 * demo-3: split base — shared base with middleware, separate route
 * groups built from same base, composed via .route()
 * tests codegen with route composition and mixed error sets
 */
...
/* shared base: all middleware applied */
...
/* group B: authenticated routes with stricter errors */
