...
The rest of this README is the capability matrix and "how to do X" snippets. All snippets come from `./examples/`.
...
- **Master spec** — full capability surface lived in the iterating monorepo workerc specs; this README plus `./docs/` are the in-repo index.
- **Behavioral harnesses** — the tier-4 tests that verify what this README documents:
