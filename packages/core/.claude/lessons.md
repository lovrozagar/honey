...
- **Why**: Cross-repo test imports (`../../../../demo/src/app.ts`) are fragile and test from the wrong perspective. Consumer tests import via the package name (`@ecomet/honey/plugin`) — exactly how real users would
- **Date**: 2026-03-13
